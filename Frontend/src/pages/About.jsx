...
import { ZapIcon, PaletteIcon, ShieldIcon, LayersIcon } from '../components/Icons';
...
const VALUES = [
  { Icon: ZapIcon,     title: 'Performance First',  desc: 'Every millisecond counts. I optimize relentlessly.', color: '#c9a84c' },
  { Icon: PaletteIcon, title: 'Design Precision',   desc: 'Pixel-perfect execution with an eye for detail.',    color: '#a852a8' },
  { Icon: ShieldIcon,  title: 'Security Minded',    desc: 'Best practices baked in from the start.',            color: '#52a87e' },
  { Icon: LayersIcon,  title: 'Collaboration',      desc: 'Clear communication and transparent process.',       color: '#5294a8' },
];
            ...
            <FadeIn delay={0.2}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }} className="values-grid">
                {VALUES.map((v, i) => {
                  const Ic = v.Icon;
                  return (
                    <div key={v.title} style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: '18px 20px', animation: `pageEnter 0.5s cubic-bezier(0.4,0,0.2,1) ${0.25 + i*0.06}s both` }}>
                      <div style={{ width: 38, height: 38, borderRadius: 10, background: `${v.color}18`, border: `1px solid ${v.color}30`, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: v.color, marginBottom: 12 }}>
                        <Ic size={18} />
                      </div>
