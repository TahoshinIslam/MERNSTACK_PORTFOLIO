  ...
  return (
    <MasterLayout>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 28px' }}>
        ...
        {/* ── Hero ──────────────────────────────────────────────── */}
        <section style={{ minHeight: '88vh', display: 'flex', alignItems: 'center', paddingTop: 40, paddingBottom: 80, position: 'relative' }}>
          ...
          <div style={{ position: 'relative', width: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
            <div>
              <FadeIn delay={0}>
              ...
              <FadeIn delay={0.1}>
                <h1 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(36px,5vw,62px)', fontWeight: 700, lineHeight: 1.1, color: 'var(--text)', marginBottom: 24 }}>
                  Creative{' '}
                  <span style={{ color: 'var(--gold)' }}>Developer</span>
                  {' '}&amp;{' '}
                  <span style={{ color: 'var(--muted2)' }}>Designer</span>
                </h1>
              </FadeIn>

              <FadeIn delay={0.2}>
                <p style={{ fontSize: 16, color: 'var(--muted2)', lineHeight: 1.75, marginBottom: 36, maxWidth: 480 }}>
                  I craft modern, performant web experiences with clean code and thoughtful design. Specializing in full-stack MERN applications.
                </p>
              </FadeIn>
            ...
            <FadeIn delay={0.25} style={{ display: 'flex', justifyContent: 'center' }}>
              <div style={{ width: '100%', maxWidth: 370, background: 'linear-gradient(135deg,var(--bg2) 0%,var(--bg3) 100%)', border: '1px solid var(--border)', borderRadius: 24, padding: 32, position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'relative', marginBottom: 20 }}>
                  <div style={{ width: 76, height: 76, borderRadius: '50%', background: 'linear-gradient(135deg,var(--gold-dim),var(--bg3))', border: '2px solid var(--gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--serif)', fontSize: 30, color: 'var(--gold)', fontWeight: 700 }}>P</div>
                  <div style={{ position: 'absolute', bottom: 2, left: 58, width: 18, height: 18, borderRadius: '50%', background: 'var(--success)', border: '2px solid var(--bg2)' }} />
                </div>

                <div style={{ fontFamily: 'var(--serif)', fontSize: 20, fontWeight: 700, color: 'var(--text)', marginBottom: 4 }}>Portfolio Owner</div>
                <div style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--gold)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 20 }}>Full-Stack Developer</div>
        ...
        <section style={{ paddingBottom: 100 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
            {SKILLS.map((skill, i) => (
              <FadeIn key={skill.name} delay={0.1 + i * 0.06}>
