...
import {
  CodeIcon, PaletteIcon, SmartphoneIcon, LinkIcon,
  CloudIcon, SearchIcon, ZapIcon, LayersIcon, ShieldIcon,
  ArrowRight,
} from '../components/Icons';

const ICON_FALLBACKS = [CodeIcon, PaletteIcon, SmartphoneIcon, LinkIcon, CloudIcon, SearchIcon, ZapIcon, LayersIcon, ShieldIcon];
...
const FALLBACK = [
  { _id: '1', title: 'Web Development',   description: 'Custom, responsive web applications built with modern frameworks. From landing pages to complex SaaS platforms.' },
  { _id: '2', title: 'UI / UX Design',    description: 'Beautiful, intuitive interfaces that delight users. Wireframes, prototypes, and production-ready design systems.' },
  { _id: '3', title: 'Mobile Apps',       description: 'Cross-platform mobile applications with React Native. Native performance, one codebase.' },
  { _id: '4', title: 'API Development',   description: 'Robust RESTful and GraphQL APIs. Clean architecture, proper documentation, and rock-solid security.' },
  { _id: '5', title: 'Cloud & DevOps',    description: 'Infrastructure setup, CI/CD pipelines, and cloud deployment on AWS, GCP, and Digital Ocean.' },
  { _id: '6', title: 'Code Review',       description: 'Expert code reviews and technical consulting to improve your team\'s codebase quality and practices.' },
];
        ...
        {loading ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(300px,1fr))', gap: 24 }}>
            {services.map((svc, i) => {
              ...
              const Ic = ICON_FALLBACKS[i % ICON_FALLBACKS.length];
              return (
                <FadeIn key={svc._id} delay={i * 0.07}>
                  ...
                  >
                    ...
                    {svc.img ? (
                      ...
                      <div style={{ width: 52, height: 52, borderRadius: 14, background: `${color}18`, border: `1px solid ${color}30`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20, color }}>
                        <Ic size={22} />
                      </div>
                    )}
                    ...
                    <div style={{ marginTop: 24, display: 'flex', alignItems: 'center', gap: 8, fontFamily: 'var(--mono)', fontSize: 11, color, letterSpacing: '0.08em' }}>
